...
def do_training(num_channels=10, num_classes=12, azm=True, chm=True, patch_size=4, log_every=5, max_epochs=50, num_workers=4, img_size=40, extra_labels='', use_queue=False,  same_embed=False, concat=False, queue_chunks=1, azm_concat=False, chm_concat=False, main_brightness=False, aug_brightness=False, rescale_pca=False):
    pca_fold = 'C:/Users/tonyt/Documents/Research/datasets/pca/abby_10_channels'
    chm_fold = 'C:/Users/tonyt/Documents/Research/datasets/chm/abby/'
    az_fold = 'C:/Users/tonyt/Documents/Research/datasets/solar_azimuth/abby'

    checkpoint_callback = ModelCheckpoint(
        dirpath='ckpts', 
        filename=f'abby_{num_channels}_channels_{num_classes}_classes_swav_structure_patch_size_{patch_size}_{extra_labels}'+'_{epoch}',
